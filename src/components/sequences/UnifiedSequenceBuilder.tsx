...
import { LocalNode, LocalConnection, NodeCategory, RandomizerBranch, TriggerItem, normalizePollOptions } from "./shared-types";
        ...
        <div className="flex-1 border border-slate-200/60 bg-[#F5F6FA] rounded-2xl overflow-hidden relative shadow-inner flex flex-col">
          ...
          >
            ...
            >
              ...
              <svg className="absolute overflow-visible top-0 left-0 w-full h-full pointer-events-auto canvas-grid">
                <defs>
                ...
                {localNodes.map(node => {
                  ...
                  return (
                    ...
                    >
                      ...
                      ) : isCondition ? null : (node.nodeType === "phone_call" || node.nodeType === "ura") ? null : isFieldOp ? (
